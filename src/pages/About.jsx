            ...
            <div className='sm:px-16 p-4 mx-auto space-y-4 text-justify'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 sm:gap-8 gap-4'>
                    <Link
                        ...
                        target='_blank'
                    >
                        <img src='/researchgate.png' className='w-12 h-12' alt='ResearchGate' />
                        <p>ResearchGate</p>
                    </Link>
                    <Link
                    ...
                    <Link
                        ...
                        target='_blank'
                    >
                        <img src='/google-scholar.png' className='w-12 h-12' alt='Google Scholar' />
                        <p>Google Scholar</p>
                    </Link>
                    <Link
                        ...
                        target='_blank'
                    >
                        <img src='/orcid.png' className='w-12 h-12' alt='ORCID' />
                        <p>ORCID</p>
                    </Link>
                </div>
            </div>
